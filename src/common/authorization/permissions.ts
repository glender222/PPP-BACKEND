...
export const PERMISSION_CATALOG = {
  ...
  'company:read': { roles: [Role.COORDINATOR, Role.AUDITOR, Role.STUDENT] },
  'company:create': { roles: [Role.COORDINATOR, Role.STUDENT] },
  'company:write': { roles: [Role.COORDINATOR, Role.STUDENT] },
  'practice:read': { roles: [Role.COORDINATOR, Role.SUPERVISOR, Role.AUDITOR, Role.STUDENT] },
  'practice:create': { roles: [Role.STUDENT] },
  'practice:authorize': { roles: [Role.COORDINATOR] },
  'practice:activate': { roles: [Role.COORDINATOR] },
  'practice:write': { roles: [Role.STUDENT] },
  'hours:validate': { roles: [Role.COORDINATOR] },
  'hours:write': { roles: [Role.STUDENT] },
  'document:review': { roles: [Role.COORDINATOR] },
  'document:read': { roles: [Role.COORDINATOR, Role.SUPERVISOR, Role.AUDITOR, Role.STUDENT] },
  'document:write': { roles: [Role.STUDENT] },
  'document:download': { roles: [Role.COORDINATOR, Role.SUPERVISOR, Role.AUDITOR, Role.STUDENT] },
